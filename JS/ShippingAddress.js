...
// ======================
// ADDRESS MODAL
let openAddress = document.querySelector(".add-address");
let closeAddress = document.querySelector("#closeAddress");
let addressOverlay = document.querySelector(".address-overlay");

openAddress.addEventListener("click", () => {
  addressOverlay.classList.add("open-addressOverlay");
});

closeAddress.addEventListener("click", () => {
  addressOverlay.classList.remove("open-addressOverlay");
});
